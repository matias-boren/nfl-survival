-- Corrected RLS policy fixes for NFL Survival app
-- This script uses the correct column names based on typical Supabase conventions
...
-- ==============================================
-- LEAGUE_INVITATIONS TABLE (CORRECTED COLUMN NAMES)
-- ==============================================
...
-- Create new policies (using snake_case column names)
...
-- ==============================================
-- NEWS_ARTICLES TABLE (OPTIONAL - ONLY IF EXISTS)
-- ==============================================
...
-- Only enable RLS on news_articles if it exists
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'news_articles' AND table_schema = 'public') THEN
